	...
	function avia_ajax_search()
	{
	    ...
	    foreach($sorted as $key => $post_type)
	    {
	        ...
	        foreach($post_type as $post)
	        {
	            ...
	            $output .= "<span class='ajax_search_image'>";
	            $output .= ($image) ?: '<i class="far fa-building"></i>';
	            $output .= "</span>";
	            $output .= "<span class='ajax_search_content'>";
	            $output .= "    <span class='ajax_search_title'>";
	    ...
	    $output .= "<a class='ajax_search_entry ajax_search_entry_view_all' href='".$search_messages['all_results_link']."'>".$search_messages['view_all_results']." <span class='avia_button_icon avia_button_icon_right' aria-hidden='true' data-av_icon='' data-av_iconfont='entypo-fontello'> </span></a>";
...
if(!function_exists('avia_print_html5_js_script'))
{
    ...
    function avia_print_html5_js_script()
    {
        ...
        $output .= '<!--[if lt IE 9]>';
        $output .= '<script src="'.$template_url.'/assets/js/html5shiv.js"></script>';
        $output .= '<![endif]-->';
        echo $output;
    }
}
