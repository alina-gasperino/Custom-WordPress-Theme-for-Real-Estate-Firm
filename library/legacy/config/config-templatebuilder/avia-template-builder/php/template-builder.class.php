...
if ( !class_exists( 'AviaBuilder' ) ) {
	...
	class AviaBuilder
	{
		...
		public function __construct()
		{
			...
			$this->paths['imagesURL']	= trailingslashit( $this->paths['pluginUrl'] ) . 'assets/images/';
    	...
    	{	
    		global $avia_config;
			   ...
			   if(!empty($avia_config['builder_redirect_id'])) $post_id = $avia_config['builder_redirect_id'];
    	   	   ...
    	   	   if('active' == get_post_meta($post_id, '_aviaLayoutBuilder_active', true) && $template = locate_template('templates/template-builder-legacy.php', false))
    	   	   {
