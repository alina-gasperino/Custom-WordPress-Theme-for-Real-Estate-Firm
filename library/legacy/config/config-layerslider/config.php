...
{	
	...
	$layerslider = get_template_directory() . '/library/legacy/config/config-layerslider/LayerSlider/layerslider.php';
	...
	if(file_exists($layerslider)) 
	{
		...
		else //not active, use theme version instead
		{
		    ...
		    $GLOBALS['lsPluginPath'] 	= get_template_directory_uri() . '/library/legacy/config/config-layerslider/LayerSlider/';
