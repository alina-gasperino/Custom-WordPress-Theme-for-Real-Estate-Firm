...
{	
	...
	*/
	define( 'AVIA_FW', AVIA_BASE . 'library/legacy/framework/' ); 
	...
	*/ 
	define( 'AVIA_FW_URL', AVIA_BASE_URL . 'library/legacy/framework/' );
	
	/**
	* AVIA_IMG_URL contains the url of the frameworks images folder
	*/ 
	define( 'AVIA_IMG_URL', AVIA_FW_URL . 'assets/images/' ); 
