...
foreach($colorsets as $set_key => $set_value)
{
	...
	$avia_elements[] = array(
						...
						"folder" => "assets/images/background-assets/images/",
						"folderlabel" => "",
							...
							<div id='pr-social-wrap' >
								<div id='pr-seconary-menu-wrap' >
									...
									<div id='avia_header_preview' >
										<div id='pr-main-area' >
											<img id='pr-logo' src='".AVIA_BASE_URL."assets/images/layout/logo.png' alt=''/>
...
$avia_elements[] =	array(
					...
					"id" 	=> "import",
					"type" 	=> "import",
					"image"	=> "includes/admin/demo_files/demo_assets/images/default.jpg"
					);
...
$avia_elements[] =	array(
					...
					"id" 	=> "import",
					"type" 	=> "import",
					"image"	=> "includes/admin/demo_files/demo_assets/images/business-flat.jpg"
					);
...
$avia_elements[] =	array(
					...
					"id" 	=> "import",
					"type" 	=> "import",
 					"image"	=> "includes/admin/demo_files/demo_assets/images/photography.jpg"
					);
...
$avia_elements[] =	array(
					...
					"id" 	=> "import",
					"type" 	=> "import",
					"image"	=> "includes/admin/demo_files/demo_assets/images/restaurant.jpg"
					);
...
$avia_elements[] =	array(
					...
					"id" 	=> "import",
					"type" 	=> "import",
 					"image"	=> "includes/admin/demo_files/demo_assets/images/restaurant-onepage.jpg"
					);
...
$avia_elements[] =	array(
					...
					"id" 	=> "import",
					"type" 	=> "import",
 					"image"	=> "includes/admin/demo_files/demo_assets/images/blog.jpg"
					);
...
$avia_elements[] =	array(
					...
					"id" 	=> "import",
					"type" 	=> "import",
 					"image"	=> "includes/admin/demo_files/demo_assets/images/coming-soon.jpg"
					);
