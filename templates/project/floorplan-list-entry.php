...
<div class="floorplan <?php echo $availability ?>" <?php echo html_data_attributes($data_attributes) ?> itemprop="containsPlace" itemscope itemtype="http://schema.org/Apartment">

	<link itemprop="containedInPlace" href="#project-<?php the_ID(); ?>">

	<div class="floorplan__thumbnail__container">
		<div class="floorplan__availability clickable <?php echo $availability ?>">
			<i class='fa fa-circle'>
				<span class="popup"><?php echo $floorplan['availability'] ?></span>
			</i>
		</div>

		<div class="floorplan__thumbnail clickable">
	...
	<div class="floorplan__info__container">	
		<div class="floorplan__title" itemprop="name">
		...
		<div class="floorplan__info__complementary">
			<div class="floorplan__type clickable">
			...
			<div class="floorplan__size clickable" itemprop="floorSize">
				<?php echo $floorplan['size'] ?> sq.ft
			</div>

			<div class="floorplan__view clickable" itemprop="amenityFeature">
				<?php echo (is_array($floorplan['exposure']) && $floorplan['exposure']) ? implode('<br>', $floorplan['exposure']) : '' ?>
			</div>

			<div class="floorplan__range clickable mobile-only">
		...
		<div class="fb__like"><?php echo fb_like_button(); ?></div>
	</div>

	<div class="floorplan__price__container">
		<div class="floorplan__pricefrom"> 
		...
		<?php if ($floorplan['price_history'] && is_user_logged_in()): ?>
			...
			<div class="floorplan__pricefrom floorplan__view-all">
